class CohortFellowsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @cohort_fellow.save
        format.html { redirect_to @cohort_fellow, notice: 'Cohort fellow was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @cohort_fellow.update(cohort_fellow_params)
        format.html { redirect_to @cohort_fellow, notice: 'Cohort fellow was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to cohort_fellows_url, notice: 'Cohort fellow was successfully destroyed.' }
