class FellowOpportunitiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @fellow_opportunity.save
        format.html { redirect_to @fellow_opportunity, notice: 'Fellow opportunity was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @fellow_opportunity.update(fellow_opportunity_params)
        format.html { redirect_to @fellow_opportunity, notice: 'Fellow opportunity was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to fellow_opportunities_url, notice: 'Fellow opportunity was successfully destroyed.' }
