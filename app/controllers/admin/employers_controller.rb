class Admin::EmployersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @employer.save
        format.html do
          redirect_to(follow_redirect || admin_employer_path(@employer), notice: 'Employer was successfully created.')
        end
  ...
  def destroy
    ...
    @employer.destroy
    respond_to do |format|
      format.html { redirect_to admin_employers_url, notice: "Employer #{name} was successfully deleted." }
