class OpportunityStagesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @opportunity_stage.save
        format.html { redirect_to @opportunity_stage, notice: 'Opportunity stage was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @opportunity_stage.update(opportunity_stage_params)
        format.html { redirect_to @opportunity_stage, notice: 'Opportunity stage was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to opportunity_stages_url, notice: 'Opportunity stage was successfully destroyed.' }
