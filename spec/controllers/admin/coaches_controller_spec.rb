...
RSpec.describe Admin::CoachesController, type: :controller do
  ...
  describe 'when signed-in user is not admin' do
    ...
    it "redirects PUT #update to home" do
      put :update, params: {id: '1001', coach: valid_attributes}, session: valid_session
      expect(response).to redirect_to(root_path)
    end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created coach" do
        post :create, params: {coach: valid_attributes}, session: valid_session
        expect(response).to redirect_to(admin_coach_path(Coach.last))
      end
    end
