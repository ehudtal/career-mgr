...
RSpec.describe Admin::TasksController, type: :controller do
  ...
  let(:valid_attributes) { {name: "Task"} }
    ...
    describe "POST #create" do
      context "with valid params" do
        ...
        it "redirects to the created task" do
          post :create, params: {opportunity_id: opportunity.id, task: valid_attributes}, session: valid_session
          expect(response).to redirect_to(admin_task_path(Task.last))
        end
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the tasks list" do
      task = Task.create! valid_attributes
      delete :destroy, params: {id: task.to_param}, session: valid_session
      expect(response).to redirect_to(admin_opportunity_tasks_url(opportunity))
    end
  end
